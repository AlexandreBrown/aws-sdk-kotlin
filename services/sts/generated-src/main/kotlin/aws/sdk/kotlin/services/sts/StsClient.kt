...
interface StsClient : SdkClient {
    ...
    companion object {
        operator fun invoke(sharedConfig: AwsClientConfig? = null, block: Config.Builder.() -> Unit = {}): StsClient {
     ...
     * resource-based policies, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html">IAM Policies in the
     * IAM User Guide.
     * Tags
     ...
     * produces.
     */
    suspend fun assumeRole(block: AssumeRoleRequest.Builder.() -> Unit) = assumeRole(AssumeRoleRequest.Builder().apply(block).build())
     ...
     * IAM User Guide.
     * <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html#iam-term-role-chaining">Role chaining limits your CLI or Amazon Web Services API role
     ...
     * IAM User Guide.
     */
    suspend fun assumeRoleWithSaml(block: AssumeRoleWithSamlRequest.Builder.() -> Unit) = assumeRoleWithSaml(AssumeRoleWithSamlRequest.Builder().apply(block).build())
     ...
     * to content in Amazon S3.
     */
    suspend fun assumeRoleWithWebIdentity(block: AssumeRoleWithWebIdentityRequest.Builder.() -> Unit) = assumeRoleWithWebIdentity(AssumeRoleWithWebIdentityRequest.Builder().apply(block).build())
     ...
     * an authorization status message, a user must be granted permissions through an IAM <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html">policy to
     ...
     * The values of condition keys in the context of the user's request.
     */
    suspend fun decodeAuthorizationMessage(block: DecodeAuthorizationMessageRequest.Builder.() -> Unit) = decodeAuthorizationMessage(DecodeAuthorizationMessageRequest.Builder().apply(block).build())
     ...
     * your root user access keys. Then, you can pull a <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_getting-report.html">credentials report to
     * learn which IAM user owns the keys. To learn who requested the temporary credentials for
     * an ASIA access key, view the STS events in your <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-integration.html">CloudTrail logs in the
     * IAM User Guide.
     ...
     * Providing a deleted access key might return an error that the key doesn't exist.
     */
    suspend fun getAccessKeyInfo(block: GetAccessKeyInfoRequest.Builder.() -> Unit) = getAccessKeyInfo(GetAccessKeyInfoRequest.Builder().apply(block).build())
     ...
     * or role is denied access. To view an example response, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_general.html#troubleshoot_general_access-denied-delete-mfa">I Am Not Authorized to Perform: iam:DeleteVirtualMFADevice in the
     * IAM User Guide.
     */
     ...
     * IAM User Guide.
     */
    suspend fun getCallerIdentity(block: GetCallerIdentityRequest.Builder.() -> Unit) = getCallerIdentity(GetCallerIdentityRequest.Builder().apply(block).build())
     ...
     * IAM User Guide.
     */
    suspend fun getSessionToken(block: GetSessionTokenRequest.Builder.() -> Unit) = getSessionToken(GetSessionTokenRequest.Builder().apply(block).build())
}
