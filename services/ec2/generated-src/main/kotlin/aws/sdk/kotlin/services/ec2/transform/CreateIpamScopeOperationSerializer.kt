...
internal class CreateIpamScopeOperationSerializer: HttpSerialize<CreateIpamScopeRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateIpamScopeRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateIpamScopeOperationBody(context, input)
...
private fun serializeCreateIpamScopeOperationBody(context: ExecutionContext, input: CreateIpamScopeRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateIpamScopeRequest"))
        trait(QueryLiteral("Action", "CreateIpamScope"))
