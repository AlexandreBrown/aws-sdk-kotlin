...
internal fun serializeAcceleratorCountRequestDocument(serializer: Serializer, input: AcceleratorCountRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("AcceleratorCountRequest"))
