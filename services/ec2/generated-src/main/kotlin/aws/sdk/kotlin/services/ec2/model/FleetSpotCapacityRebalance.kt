 ...
 */
class FleetSpotCapacityRebalance private constructor(builder: Builder) {
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.FleetSpotCapacityRebalance = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.FleetSpotCapacityRebalance = Builder(this).apply(block).build()
    ...
    class Builder {
        ...
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.FleetSpotCapacityRebalance) : this() {
            this.replacementStrategy = x.replacementStrategy
            this.terminationDelay = x.terminationDelay
        }

        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.FleetSpotCapacityRebalance = FleetSpotCapacityRebalance(this)
    }
}
