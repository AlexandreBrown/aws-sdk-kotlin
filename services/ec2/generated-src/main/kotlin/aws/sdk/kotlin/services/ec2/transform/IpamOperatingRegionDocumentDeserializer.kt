...
internal fun deserializeIpamOperatingRegionDocument(deserializer: Deserializer): IpamOperatingRegion {
    val builder = IpamOperatingRegion.Builder()
    val REGIONNAME_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("regionName"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("IpamOperatingRegion"))
