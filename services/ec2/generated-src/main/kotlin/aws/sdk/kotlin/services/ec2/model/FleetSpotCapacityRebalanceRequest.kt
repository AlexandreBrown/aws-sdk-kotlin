 ...
 * For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-configuration-strategies.html#ec2-fleet-capacity-rebalance">Capacity rebalancing in the Amazon EC2 User Guide.
 */
class FleetSpotCapacityRebalanceRequest private constructor(builder: Builder) {
    /**
     ...
     */
    val replacementStrategy: aws.sdk.kotlin.services.ec2.model.FleetReplacementStrategy? = builder.replacementStrategy
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.FleetSpotCapacityRebalanceRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.FleetSpotCapacityRebalanceRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * instances that received a rebalance notification.
         */
        var replacementStrategy: aws.sdk.kotlin.services.ec2.model.FleetReplacementStrategy? = null
        /**
         * The amount of time (in seconds) that Amazon EC2 waits before terminating the old Spot
         * Instance after launching a new replacement Spot Instance.
         * Valid only when ReplacementStrategy is set to launch-before-terminate.
