...
internal fun deserializeInstanceTypeInfoFromInstanceRequirementsDocument(deserializer: Deserializer): InstanceTypeInfoFromInstanceRequirements {
    val builder = InstanceTypeInfoFromInstanceRequirements.Builder()
    val INSTANCETYPE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("instanceType"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("InstanceTypeInfoFromInstanceRequirements"))
