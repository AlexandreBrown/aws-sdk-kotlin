...
internal class GetIpamAddressHistoryOperationSerializer: HttpSerialize<GetIpamAddressHistoryRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetIpamAddressHistoryRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetIpamAddressHistoryOperationBody(context, input)
...
private fun serializeGetIpamAddressHistoryOperationBody(context: ExecutionContext, input: GetIpamAddressHistoryRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetIpamAddressHistoryRequest"))
        trait(QueryLiteral("Action", "GetIpamAddressHistory"))
