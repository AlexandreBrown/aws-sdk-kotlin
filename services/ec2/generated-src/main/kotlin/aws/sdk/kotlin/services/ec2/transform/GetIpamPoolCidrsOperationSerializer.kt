...
internal class GetIpamPoolCidrsOperationSerializer: HttpSerialize<GetIpamPoolCidrsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetIpamPoolCidrsRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetIpamPoolCidrsOperationBody(context, input)
...
private fun serializeGetIpamPoolCidrsOperationBody(context: ExecutionContext, input: GetIpamPoolCidrsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetIpamPoolCidrsRequest"))
        trait(QueryLiteral("Action", "GetIpamPoolCidrs"))
