...
internal fun serializeNetworkInterfaceCountRequestDocument(serializer: Serializer, input: NetworkInterfaceCountRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("NetworkInterfaceCountRequest"))
