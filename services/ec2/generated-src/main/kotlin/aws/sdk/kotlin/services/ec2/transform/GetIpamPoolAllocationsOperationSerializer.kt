...
internal class GetIpamPoolAllocationsOperationSerializer: HttpSerialize<GetIpamPoolAllocationsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetIpamPoolAllocationsRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetIpamPoolAllocationsOperationBody(context, input)
...
private fun serializeGetIpamPoolAllocationsOperationBody(context: ExecutionContext, input: GetIpamPoolAllocationsRequest): ByteArray {
    ...
    val IPAMPOOLALLOCATIONID_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("IpamPoolAllocationId"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetIpamPoolAllocationsRequest"))
        trait(QueryLiteral("Action", "GetIpamPoolAllocations"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.ipamPoolAllocationId?.let { field(IPAMPOOLALLOCATIONID_DESCRIPTOR, it) }
