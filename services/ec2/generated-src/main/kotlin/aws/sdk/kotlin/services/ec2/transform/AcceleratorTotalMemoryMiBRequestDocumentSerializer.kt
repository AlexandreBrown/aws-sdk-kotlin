...
internal fun serializeAcceleratorTotalMemoryMiBRequestDocument(serializer: Serializer, input: AcceleratorTotalMemoryMiBRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("AcceleratorTotalMemoryMiBRequest"))
