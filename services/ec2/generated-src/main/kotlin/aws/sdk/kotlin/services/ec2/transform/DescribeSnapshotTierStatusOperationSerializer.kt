...
internal class DescribeSnapshotTierStatusOperationSerializer: HttpSerialize<DescribeSnapshotTierStatusRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeSnapshotTierStatusRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeSnapshotTierStatusOperationBody(context, input)
...
private fun serializeDescribeSnapshotTierStatusOperationBody(context: ExecutionContext, input: DescribeSnapshotTierStatusRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeSnapshotTierStatusRequest"))
        trait(QueryLiteral("Action", "DescribeSnapshotTierStatus"))
