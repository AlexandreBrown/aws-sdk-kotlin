...
internal fun serializeInstanceRequirementsRequestDocument(serializer: Serializer, input: InstanceRequirementsRequest) {
    val ACCELERATORCOUNT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, FormUrlSerialName("AcceleratorCount"))
    val ACCELERATORMANUFACTURERS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("AcceleratorManufacturer"), FormUrlFlattened)
    val ACCELERATORNAMES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("AcceleratorName"), FormUrlFlattened)
    ...
    val ACCELERATORTYPES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("AcceleratorType"), FormUrlFlattened)
    ...
    val CPUMANUFACTURERS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("CpuManufacturer"), FormUrlFlattened)
    val EXCLUDEDINSTANCETYPES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("ExcludedInstanceType"), FormUrlFlattened)
    val INSTANCEGENERATIONS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("InstanceGeneration"), FormUrlFlattened)
    val LOCALSTORAGE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("LocalStorage"))
    val LOCALSTORAGETYPES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("LocalStorageType"), FormUrlFlattened)
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("InstanceRequirementsRequest"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        input.vCpuCount?.let { field(VCPUCOUNT_DESCRIPTOR, it, ::serializeVCpuCountRangeRequestDocument) }
