...
class DescribeLaunchTemplateVersionsRequest private constructor(builder: Builder) {
    /**
     ...
     */
    val maxVersion: kotlin.String? = builder.maxVersion
    /**
     * The version number after which to describe launch template versions.
     */
    val minVersion: kotlin.String? = builder.minVersion
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeLaunchTemplateVersionsRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeLaunchTemplateVersionsRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * The version number up to which to describe launch template versions.
         */
        var maxVersion: kotlin.String? = null
        /**
         * The version number after which to describe launch template versions.
         */
        var minVersion: kotlin.String? = null
        /**
         * The token to request the next page of results.
         */
