 ...
 */
class LaunchTemplateInstanceMetadataOptions private constructor(builder: Builder) {
    /**
     ...
     */
    val state: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptionsState? = builder.state

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptions = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptions = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * applied - The metadata options have been successfully applied on the instance.
         */
        var state: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptionsState? = null

        internal constructor()
        @PublishedApi
        internal constructor(x: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptions) : this() {
        ...
        @PublishedApi
        internal fun build(): aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMetadataOptions = LaunchTemplateInstanceMetadataOptions(this)
    }
}
