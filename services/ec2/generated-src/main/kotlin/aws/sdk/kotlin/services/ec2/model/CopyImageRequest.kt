 ...
 */
class CopyImageRequest private constructor(builder: Builder) {
    /**
     ...
     */
    val sourceImageId: kotlin.String? = builder.sourceImageId
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.CopyImageRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.CopyImageRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * The ID of the AMI to copy.
         */
        var sourceImageId: kotlin.String? = null
        /**
         * The name of the Region that contains the AMI to copy.
         */
