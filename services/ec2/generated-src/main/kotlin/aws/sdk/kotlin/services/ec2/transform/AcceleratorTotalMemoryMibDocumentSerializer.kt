...
internal fun serializeAcceleratorTotalMemoryMibDocument(serializer: Serializer, input: AcceleratorTotalMemoryMib) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("AcceleratorTotalMemoryMib"))
