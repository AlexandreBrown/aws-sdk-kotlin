...
class DescribeImagesRequest private constructor(builder: Builder) {
    /**
     ...
     */
    val includeDeprecated: kotlin.Boolean? = builder.includeDeprecated
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.DescribeImagesRequest = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.DescribeImagesRequest = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * If you are the AMI owner, all deprecated AMIs appear in the response regardless of the value (true or false) that you set for this parameter.
         */
        var includeDeprecated: kotlin.Boolean? = null
        /**
         * Scopes the results to images with the specified owners. You can specify a combination of
         * Amazon Web Services account IDs, self, amazon, and aws-marketplace.
         * If you omit this parameter, the results include all images for which you have launch permissions,
