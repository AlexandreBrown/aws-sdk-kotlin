...
internal fun deserializeIpamResourceTagDocument(deserializer: Deserializer): IpamResourceTag {
    val builder = IpamResourceTag.Builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("IpamResourceTag"))
