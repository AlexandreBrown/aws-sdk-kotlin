...
internal fun deserializeSpotPlacementScoreDocument(deserializer: Deserializer): SpotPlacementScore {
    val builder = SpotPlacementScore.Builder()
    ...
    val SCORE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Integer, XmlSerialName("score"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("SpotPlacementScore"))
