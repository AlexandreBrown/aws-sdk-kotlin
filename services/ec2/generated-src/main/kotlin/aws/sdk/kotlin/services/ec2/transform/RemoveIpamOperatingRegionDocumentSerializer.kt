...
internal fun serializeRemoveIpamOperatingRegionDocument(serializer: Serializer, input: RemoveIpamOperatingRegion) {
    val REGIONNAME_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("RegionName"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("RemoveIpamOperatingRegion"))
