...
internal fun serializeBaselineEbsBandwidthMbpsRequestDocument(serializer: Serializer, input: BaselineEbsBandwidthMbpsRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("BaselineEbsBandwidthMbpsRequest"))
