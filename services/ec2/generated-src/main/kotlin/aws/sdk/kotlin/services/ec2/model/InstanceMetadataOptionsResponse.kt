 ...
 */
class InstanceMetadataOptionsResponse private constructor(builder: Builder) {
    /**
     ...
     * instance.
     */
    val state: aws.sdk.kotlin.services.ec2.model.InstanceMetadataOptionsState? = builder.state

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.InstanceMetadataOptionsResponse = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.InstanceMetadataOptionsResponse = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * instance.
         */
        var state: aws.sdk.kotlin.services.ec2.model.InstanceMetadataOptionsState? = null
