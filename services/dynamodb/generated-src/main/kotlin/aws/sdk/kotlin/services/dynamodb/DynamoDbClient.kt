...
interface DynamoDbClient : SdkClient {
    ...
    companion object {
        operator fun invoke(sharedConfig: AwsClientConfig? = null, block: Config.Builder.() -> Unit = {}): DynamoDbClient {
     ...
     * For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ErrorHandling.html#BatchOperations">Batch Operations and Error Handling in the Amazon DynamoDB
     * Developer Guide.
     ...
     * Guide.
     */
    suspend fun batchGetItem(block: BatchGetItemRequest.Builder.() -> Unit) = batchGetItem(BatchGetItemRequest.Builder().apply(block).build())
     ...
     * The total request size exceeds 16 MB.
     */
    suspend fun batchWriteItem(block: BatchWriteItemRequest.Builder.() -> Unit) = batchWriteItem(BatchWriteItemRequest.Builder().apply(block).build())
     ...
     * Provisioned read and write capacity
     */
    suspend fun createBackup(block: CreateBackupRequest.Builder.() -> Unit) = createBackup(CreateBackupRequest.Builder().apply(block).build())
     ...
     * your global table.
     */
    suspend fun createGlobalTable(block: CreateGlobalTableRequest.Builder.() -> Unit) = createGlobalTable(CreateGlobalTableRequest.Builder().apply(block).build())
     ...
     * second.
     */
    suspend fun deleteBackup(block: DeleteBackupRequest.Builder.() -> Unit) = deleteBackup(DeleteBackupRequest.Builder().apply(block).build())
     ...
     * deleted.
     */
    suspend fun deleteItem(block: DeleteItemRequest.Builder.() -> Unit) = deleteItem(DeleteItemRequest.Builder().apply(block).build())
     ...
     * second.
     */
    suspend fun describeBackup(block: DescribeBackupRequest.Builder.() -> Unit) = describeBackup(DescribeBackupRequest.Builder().apply(block).build())
     ...
     * second.
     */
    suspend fun describeContinuousBackups(block: DescribeContinuousBackupsRequest.Builder.() -> Unit) = describeContinuousBackups(DescribeContinuousBackupsRequest.Builder().apply(block).build())
     ...
     * index.
     */
    suspend fun describeContributorInsights(block: DescribeContributorInsightsRequest.Builder.() -> Unit) = describeContributorInsights(DescribeContributorInsightsRequest.Builder().apply(block).build())
     ...
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version
     * 2017.11.29 of global tables. If you are using global tables <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version
     * 2019.11.21 you can use <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DescribeTable.html">DescribeTable instead.
     */
     ...
     * 2019.11.21 you can use <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DescribeTable.html">DescribeTable instead.
     */
    suspend fun describeGlobalTable(block: DescribeGlobalTableRequest.Builder.() -> Unit) = describeGlobalTable(DescribeGlobalTableRequest.Builder().apply(block).build())
     ...
     * 2017.11.29 of global tables.
     */
    suspend fun describeGlobalTableSettings(block: DescribeGlobalTableSettingsRequest.Builder.() -> Unit) = describeGlobalTableSettings(DescribeGlobalTableSettingsRequest.Builder().apply(block).build())
     ...
     * Returns information about the status of Kinesis streaming.
     */
    suspend fun describeKinesisStreamingDestination(block: DescribeKinesisStreamingDestinationRequest.Builder.() -> Unit) = describeKinesisStreamingDestination(DescribeKinesisStreamingDestinationRequest.Builder().apply(block).build())
     ...
     * Developer Guide.
     * Although you can increase these quotas by filing a case at <a href="https://console.aws.amazon.com/support/home#/">Amazon Web Services Support Center, obtaining the
     ...
     * The DescribeLimits Request element has no content.
     */
    suspend fun describeLimits(block: DescribeLimitsRequest.Builder.() -> Unit) = describeLimits(DescribeLimitsRequest.Builder().apply(block).build())
     ...
     * 2019.11.21 of global tables.
     */
    suspend fun describeTableReplicaAutoScaling(block: DescribeTableReplicaAutoScalingRequest.Builder.() -> Unit) = describeTableReplicaAutoScaling(DescribeTableReplicaAutoScalingRequest.Builder().apply(block).build())
     ...
     * Gives a description of the Time to Live (TTL) status on the specified table.
     */
    suspend fun describeTimeToLive(block: DescribeTimeToLiveRequest.Builder.() -> Unit) = describeTimeToLive(DescribeTimeToLiveRequest.Builder().apply(block).build())
     ...
     * without deleting either of the resources.
     */
    suspend fun disableKinesisStreamingDestination(block: DisableKinesisStreamingDestinationRequest.Builder.() -> Unit) = disableKinesisStreamingDestination(DisableKinesisStreamingDestinationRequest.Builder().apply(block).build())
     ...
     * is ACTIVE.
     */
    suspend fun enableKinesisStreamingDestination(block: EnableKinesisStreamingDestinationRequest.Builder.() -> Unit) = enableKinesisStreamingDestination(EnableKinesisStreamingDestinationRequest.Builder().apply(block).build())
     ...
     * manner to ConditionCheck in the <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/transaction-apis.html#transaction-apis-txwriteitems">TransactWriteItems API.
     */
     ...
     * manner to ConditionCheck in the <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/transaction-apis.html#transaction-apis-txwriteitems">TransactWriteItems API.
     */
    suspend fun executeTransaction(block: ExecuteTransactionRequest.Builder.() -> Unit) = executeTransaction(ExecuteTransactionRequest.Builder().apply(block).build())
     ...
     * window.
     */
    suspend fun exportTableToPointInTime(block: ExportTableToPointInTimeRequest.Builder.() -> Unit) = exportTableToPointInTime(ExportTableToPointInTimeRequest.Builder().apply(block).build())
     ...
     * eventually consistent read, it always returns the last updated value.
     */
    suspend fun getItem(block: GetItemRequest.Builder.() -> Unit) = getItem(GetItemRequest.Builder().apply(block).build())
     ...
     * You can call ListBackups a maximum of five times per second.
     */
    suspend fun listBackups(block: ListBackupsRequest.Builder.() -> Unit) = listBackups(ListBackupsRequest.Builder().apply(block).build())
     ...
     * indexes.
     */
    suspend fun listContributorInsights(block: ListContributorInsightsRequest.Builder.() -> Unit) = listContributorInsights(ListContributorInsightsRequest.Builder().apply(block).build())
     ...
     * 2017.11.29 of global tables.
     */
    suspend fun listGlobalTables(block: ListGlobalTablesRequest.Builder.() -> Unit) = listGlobalTables(ListGlobalTablesRequest.Builder().apply(block).build())
     ...
     * For an overview on tagging DynamoDB resources, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Tagging.html">Tagging for DynamoDB
     ...
     * in the Amazon DynamoDB Developer Guide.
     */
    suspend fun listTagsOfResource(block: ListTagsOfResourceRequest.Builder.() -> Unit) = listTagsOfResource(ListTagsOfResourceRequest.Builder().apply(block).build())
     ...
     * <a href="http://docs.aws.amazon.com/goto/aws-cli/dynamodb-2012-08-10/PutItem"> PutItem in the Command Line Interface
     * <a href="http://docs.aws.amazon.com/goto/DotNetSDKV3/dynamodb-2012-08-10/PutItem"> PutItem in the SDK for .NET
     * <a href="http://docs.aws.amazon.com/goto/SdkForCpp/dynamodb-2012-08-10/PutItem"> PutItem in the SDK for C++
     * <a href="http://docs.aws.amazon.com/goto/SdkForGoV1/dynamodb-2012-08-10/PutItem"> PutItem in the SDK for Go
     * <a href="http://docs.aws.amazon.com/goto/SdkForJava/dynamodb-2012-08-10/PutItem"> PutItem in the SDK for Java
     * <a href="http://docs.aws.amazon.com/goto/AWSJavaScriptSDK/dynamodb-2012-08-10/PutItem"> PutItem in the SDK for JavaScript
     * <a href="http://docs.aws.amazon.com/goto/SdkForPHPV3/dynamodb-2012-08-10/PutItem"> PutItem in the SDK for PHP V3
     * <a href="http://docs.aws.amazon.com/goto/boto3/dynamodb-2012-08-10/PutItem">
     * PutItem in the SDK for Python (Boto)
     * <a href="http://docs.aws.amazon.com/goto/SdkForRubyV2/dynamodb-2012-08-10/PutItem"> PutItem in the SDK for Ruby V2
     ...
     * For more information about PutItem, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithItems.html">Working with
     ...
     * Items in the Amazon DynamoDB Developer Guide.
     */
    suspend fun putItem(block: PutItemRequest.Builder.() -> Unit) = putItem(PutItemRequest.Builder().apply(block).build())
     ...
     * Time to Live (TTL) settings
     */
    suspend fun restoreTableFromBackup(block: RestoreTableFromBackupRequest.Builder.() -> Unit) = restoreTableFromBackup(RestoreTableFromBackupRequest.Builder().apply(block).build())
     ...
     * Point in time recovery settings
     */
    suspend fun restoreTableToPointInTime(block: RestoreTableToPointInTimeRequest.Builder.() -> Unit) = restoreTableToPointInTime(RestoreTableToPointInTimeRequest.Builder().apply(block).build())
     ...
     * to true.
     */
    suspend fun scan(block: ScanRequest.Builder.() -> Unit) = scan(ScanRequest.Builder().apply(block).build())
     ...
     * The aggregate size of the items in the transaction cannot exceed 4 MB.
     */
    suspend fun transactGetItems(block: TransactGetItemsRequest.Builder.() -> Unit) = transactGetItems(TransactGetItemsRequest.Builder().apply(block).build())
     ...
     * There is a user error, such as an invalid data format.
     */
    suspend fun transactWriteItems(block: TransactWriteItemsRequest.Builder.() -> Unit) = transactWriteItems(TransactWriteItemsRequest.Builder().apply(block).build())
     ...
     * You can restore your table to any point in time during the last 35 days.
     */
    suspend fun updateContinuousBackups(block: UpdateContinuousBackupsRequest.Builder.() -> Unit) = updateContinuousBackups(UpdateContinuousBackupsRequest.Builder().apply(block).build())
     ...
     * should not enable CloudWatch Contributor Insights for DynamoDB for this table.
     */
    suspend fun updateContributorInsights(block: UpdateContributorInsightsRequest.Builder.() -> Unit) = updateContributorInsights(UpdateContributorInsightsRequest.Builder().apply(block).build())
     ...
     * capacity units.
     */
    suspend fun updateGlobalTable(block: UpdateGlobalTableRequest.Builder.() -> Unit) = updateGlobalTable(UpdateGlobalTableRequest.Builder().apply(block).build())
     ...
     * Updates settings for a global table.
     */
    suspend fun updateGlobalTableSettings(block: UpdateGlobalTableSettingsRequest.Builder.() -> Unit) = updateGlobalTableSettings(UpdateGlobalTableSettingsRequest.Builder().apply(block).build())
     ...
     * operation using the ReturnValues parameter.
     */
    suspend fun updateItem(block: UpdateItemRequest.Builder.() -> Unit) = updateItem(UpdateItemRequest.Builder().apply(block).build())
     ...
     * 2019.11.21 of global tables.
     */
    suspend fun updateTableReplicaAutoScaling(block: UpdateTableReplicaAutoScalingRequest.Builder.() -> Unit) = updateTableReplicaAutoScaling(UpdateTableReplicaAutoScalingRequest.Builder().apply(block).build())
     ...
     * operation.
     * For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/TTL.html">Time To Live in the
     ...
     * Amazon DynamoDB Developer Guide.
     */
    suspend fun updateTimeToLive(block: UpdateTimeToLiveRequest.Builder.() -> Unit) = updateTimeToLive(UpdateTimeToLiveRequest.Builder().apply(block).build())
}
