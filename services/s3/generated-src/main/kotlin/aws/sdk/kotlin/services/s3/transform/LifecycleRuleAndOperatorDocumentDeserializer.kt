...
internal fun deserializeLifecycleRuleAndOperatorDocument(deserializer: Deserializer): LifecycleRuleAndOperator {
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                OBJECTSIZEGREATERTHAN_DESCRIPTOR.index -> builder.objectSizeGreaterThan = deserializeLong()
                OBJECTSIZELESSTHAN_DESCRIPTOR.index -> builder.objectSizeLessThan = deserializeLong()
