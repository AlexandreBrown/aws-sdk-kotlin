...
dependencies {
    ...
    implementation("aws.smithy.kotlin:http:0.7.5-SNAPSHOT")
    implementation(project(":aws-runtime:http-client-engine-crt"))
    implementation("aws.smithy.kotlin:serde:0.7.5-SNAPSHOT")
    implementation("aws.smithy.kotlin:serde-xml:0.7.5-SNAPSHOT")
    implementation("aws.smithy.kotlin:utils:0.7.5-SNAPSHOT")
    ...
    testImplementation("aws.smithy.kotlin:smithy-test:0.7.5-SNAPSHOT")
